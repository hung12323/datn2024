...
// import { View, Text, Image, StyleSheet, StatusBar, TouchableOpacity, ScrollView, RefreshControl ,Modal} from 'react-native';
...
import React, { useEffect, useState } from 'react';
import { View, Text, Image, StyleSheet, StatusBar, TouchableOpacity, ScrollView, RefreshControl, Modal, Button } from 'react-native';
import messaging from '@react-native-firebase/messaging';
import database from '@react-native-firebase/database';
import { useNavigation } from '@react-navigation/native';
import Head from '../Head';
...
function Notification({ visible, onRequestClose }): JSX.Element {
  const [notificationData, setNotificationData] = useState([]);
  const [newsData, setNewsData] = useState(null);
  const newsRef = firebase.database().ref('data');
  const [refreshing, setRefreshing] = useState(false); // Thêm state refreshing
    ...
    <Modal visible={visible} onRequestClose={onRequestClose}>
      ...
      <View style={styles. updateinfo}>
        ...
        <View style={{ flexDirection: 'row', width: '88%', }}>
          ...
          <TouchableOpacity style={{ marginTop: 17, marginLeft: 60, height: 40, 
            width: 55, backgroundColor: '#1877F2', 
            justifyContent: 'center' }} onPress={onRequestClose} >
            <Text style={{ color: 'black', fontSize: 18, textAlign: 'center' }}>Close</Text>
          </TouchableOpacity>
